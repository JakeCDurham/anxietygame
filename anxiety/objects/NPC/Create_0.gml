...
myText[1] = ["Of course. I can get that to you soon", "It might take me a while", "When do you need it by?"];
myText[2] = "Perfect!";
...
myScripts[1] = [[scr_flyingWords,["Of", "course.", "I", "can", "get", "that", "to", "you", "soon."], true],[scr_flyingWords, ["It", "might", "take", "me", "a", "while"], true],[scr_flyingWords, ["When", "do", "you", "need", "it", "by?"], true]];
